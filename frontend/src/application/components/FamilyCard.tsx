...
export const FamilyCard: React.FC<FamilyCardProps> = ({ data, onClick, visibleNodeIds, onHighlightParent, onEdit }) => {
  ...
  const handleEditClick = (e: React.MouseEvent) => {
    ...
    e.stopPropagation();
    if (onEdit) {
      onEdit(`/admin/person/person/${data.id}/change/`);
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          href={`/admin/person/person/${data.id}/change/`}
